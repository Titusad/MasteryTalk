...
const PATH_META = {
  interview: { icon: Target, label: "Interview", emoji: "🎯" },
  sales: { icon: Briefcase, label: "Sales", emoji: "💼" },
} as const;
...
export function PracticeDropdown({ onSelect }: PracticeDropdownProps) {
  ...
  const handleSelect = (pathId: "interview" | "sales") => {
    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {(["interview", "sales"] as const).map((pathId) => {
