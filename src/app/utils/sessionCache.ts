...
export const cvMatchCacheV2 = {
    get: (sKey: string) => getItem<any>(`cvmatchV2_${sKey}`),
    set: (sKey: string, data: any) => setItem(`cvmatchV2_${sKey}`, data),
    clear: (sKey: string) => removeItem(`cvmatchV2_${sKey}`),
};
