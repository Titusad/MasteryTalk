              ...
              >
                <div className="px-12 pb-12 pt-5">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <button
                      className="w-full border-2 border-gray-200 bg-white text-gray-700 hover:bg-gray-50 py-4 rounded-full flex items-center justify-center gap-3 transition-all"
                      style={{ fontWeight: 500 }}
