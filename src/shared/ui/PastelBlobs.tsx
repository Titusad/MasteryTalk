...
export function PastelBlobs() {
    return (
        <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
            ...
            <div className="absolute bottom-0 right-0 w-[350px] h-[350px] rounded-full opacity-30" style={{ background: COLORS.mint, filter: "blur(120px)" }} />
            <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[200px] rounded-full opacity-20" style={{ background: COLORS.softEmerald, filter: "blur(120px)" }} />
        </div>
    );
}
