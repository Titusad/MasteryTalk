            ...
            >
                ...
                <div className="px-6 pb-6">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {/* ═══════════════════════════════════════
                            RESULT — Redesigned: compact score + hero word analysis
                           ═══════════════════════════════════════ */}
                        {phase === "result" && result && (
                            <motion.div
                                key="result"
                            ...
                            >
                                ...
                                >
                                    <span
                                        ...
                                        style={{ fontWeight: 800, color: scoreColor(result.accuracy), fontVariantNumeric: "tabular-nums" }}
                                    >
                                    ...
                                    <div className="w-full mt-4">
                                        ...
                                        <div className="flex flex-wrap gap-2 p-4 bg-[#f8fafc] rounded-xl border border-[#e2e8f0]">
                                            {result.wordResults.map((w, i) => {
                                                const isGood = w.score >= 80;
                                                const isWarn = w.score >= 60 && w.score < 80;
                                                const isBad = w.score < 60;
                                                const isError = w.errorType && w.errorType !== "None";
                                                const color = isGood ? "#334155" : isWarn ? "#b45309" : "#dc2626";
                                                const bg = isGood ? "transparent" : isWarn ? "#fef3c7" : "#fee2e2";
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <span
                                                            ...
                                                            style={{ color, fontWeight: (isWarn || isBad) ? 700 : 500 }}
                                                        >
                                                            {w.word}
                                                        </span>
                                                        <span
                                                            className="text-[10px] mt-0.5 leading-tight"
                                                            style={{ color: isGood ? "#22c55e" : color, fontWeight: 500, opacity: isGood ? 0.7 : 0.9 }}
                                                        >
                                                            {isError
                                                                ? w.errorType === "Omission" ? "skipped"
                                                                : w.errorType === "Insertion" ? "extra"
                                                                : w.errorType === "Mispronunciation" ? "check sounds"
                                                                : `${Math.round(w.score)}%`
                                                            : `${Math.round(w.score)}%`}
                                                        </span>
                                                    </div>
                                ...
                                {result.fluency < 80 && (
                                    <div className="w-full mt-3 bg-[#f0fdfa] border border-[#ccfbf1] rounded-xl p-3 flex gap-3 text-left">
                                        ...
                                        <p className="text-xs text-[#134e4a] leading-relaxed">
                                            ...
                                            Your rhythm sounds choppy. Try grouping words together <em>(linking)</em> instead of saying them one by one. Listen to the AI again to mimic its flow.
                                        </p>
                                    </div>
                                )}
