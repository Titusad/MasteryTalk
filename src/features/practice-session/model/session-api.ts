...
/* ═══════════════════════════════════════════════════════════
   Personalize Strategy Patterns (bad/good examples)
   ═══════════════════════════════════════════════════════════ */
...
export interface PersonalizedPatterns {
  bad: PersonalizedPattern;
  good: PersonalizedPattern;
}

export async function personalizePatterns(
  levelId: string,
  ...
  signal?: AbortSignal,
): Promise<PersonalizedPatterns> {
  const res = await authFetch("/progression/personalize-patterns", {
    levelId,
    methodologyName,
    badLabel,
    goodLabel,
