...
export type {
  BriefLocale,
  TranslatedBriefContent,
  LevelMethodology,
  SelfIntroContext,
} from "@/entities/session";
export { SELF_INTRO_CONTEXTS } from "@/shared/lib/self-intro-contexts";
...
/* SelfIntroContext and SELF_INTRO_CONTEXTS are re-exported from their
   canonical locations (entities/session and shared/lib/self-intro-contexts). */
