...
- Name the framework in the 'framework.name' field (e.g. "Present-First Narrative", "STAR Method", "Problem-Solution", "Direct Pitch")
- ⚠️ Do NOT use the name "Career Timeline" — for questions like "Walk me through your background", use "Present-First Narrative" instead. The candidate should ALWAYS lead with what they do TODAY, then add past context briefly, then connect to the target role.
...
- 'suggestedOpener': The FIRST sentence the candidate should say — write it ready-to-speak, first person
  ⚠️ CRITICAL: The 'suggestedOpener' must NEVER mention the framework name (e.g. do NOT write "Use the STAR method" or "Following the Problem-Solution framework"). It must be a natural, ready-to-say opening line.
  ⚠️ COHERENCE RULE: The 'suggestedOpener' MUST directly apply the methodology described in 'approach' and 'framework'. If the framework says "lead with the present", the opener MUST start with a present-tense statement about what the user does TODAY — never "My career began at..." or "I started in...". Contradicting your own advice is the #1 quality failure.
